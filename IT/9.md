...
1. **DMZ pro veřejný web:** Webový server firmy je v DMZ, protože musí být dostupný z internetu. Databáze s osobními údaji ale zůstává ve vnitřní síti za dalším firewallem, takže kompromitace webu automaticky neznamená přístup k databázi.
2. **Mikrosegmentace uvnitř firmy:** Počítač recepce nemá síťově povolený přístup k účetní databázi. Pokud se nakazí malwarem, interní firewall zabrání laterálnímu pohybu k citlivým serverům.
